...
<body class="<?php print $classes; ?>">
	...
	<div class="section clearfix">
      ...
      <?php if ($primary_links || $navigation): ?>
	    ...
	    <div class="section clearfix">
          ...
          <div id='primary' class='menu suckerfish'><?php print menu_tree($menu_name = 'primary-links'); ?></div>
  ...
  <script>
    ...
    $.ajax({
      ...
      url: "https://sheetlabs.com/OOKB/cafemanpbs",
      crossDomain : true,
    })
    .done(function(data) {
      if (data.length == 0) {
...
<!--
  <script>
    ...
    var mySpreadsheet = 'https://docs.google.com/spreadsheet/ccc?key=1oDS6TT7iPQb5ngYQFmd0Sbo89n8IvrwZrleumKUBoA8#gid=0';
